...
data class PracticeNight(
        val api_result: Int = 0,
        val api_result_msg: String = "",
        val api_data: PracticeNightApiData? = PracticeNightApiData()
) : JsonBean() {
    override fun process() {
        ...
        Battle.calcRank()
        Battle.phaseShift(Battle.Phase.PracticeNight)
    }
}

data class PracticeNightApiData(
